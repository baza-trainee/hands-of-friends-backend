...
# General help texts
IMAGE_HELP_TEXT = _(
    f"Зображення має бути у форматі .jpg, .jpeg, .webp, .png або .svg. Після завантаження зображення "
    f"буде автоматично компресоване до {int(MAX_FILE_SIZE / 1024 / 1024)} МБ та змінено на формат .webp."
)
...
TEXT_LENGTH_HELP_TEXT_120 = _("Максимальна довжина тексту: 120 символів.")
...
TEXT_LENGTH_HELP_TEXT_1600 = _("Максимальна довжина тексту: 1600 символів.")
